...
public class PrimeStrangeAttractor {
    ...
    private static void printScriptTag(PrintWriter pw) throws Exception {
        ...
        pw.println("\t\tctx.arc(centerX, centerY, (5000000 * SCALING_FACTOR) / 2, 02 * Math.PI ;");
        pw.println("\t\tctx.arc(centerX, centerY, (10000000 * SCALING_FACTOR) / 2, 02 * Math.PI ;");
        pw.println("\t\tctx.arc(centerX, centerY, (15000000 * SCALING_FACTOR) / 2, 02 * Math.PI ;");
        pw.println("\t\tctx.lineWidth = AXIS_WIDTH;");
        pw.println("\t\tctx.stroke();");
        pw.println("\t};");
        pw.println();

...
public class PrimeStrangeAttractor {
    private static final int CANVAS_SIZE = 18000;
    private static final int CANVAS_ZOOM = 2;
    ...
    private static void printScriptTag(PrintWriter pw) throws Exception {
        ...
        pw.println("\tconst POLAR_REVOLUTIONS = 1;");
        
        pw.println("\t const MAX_PRIME_LIMIT = 16000000;");
        pw.println("\tconst RADIUS_SCALING_FACTOR  = (Math.PI * 2 / centerX) / (POLAR_REVOLUTIONS * Math.PI * 2); // radius scaling");
        pw.println();
        ...
        pw.println("\t\tctx.arc(centerX, centerY, ((5000000 / MAX_PRIME_LIMIT) * RADIUS_SCALING_FACTOR), 0, 2 * Math.PI);");
        pw.println("\t\tctx.arc(centerX, centerY, ((10000000 / MAX_PRIME_LIMIT) * RADIUS_SCALING_FACTOR), 0, 2 * Math.PI);");
        pw.println("\t\tctx.arc(centerX, centerY, ((15000000 / MAX_PRIME_LIMIT) * RADIUS_SCALING_FACTOR), 0, 2 * Math.PI);");
        pw.println("\t\tctx.lineWidth = AXIS_WIDTH;");
        pw.println("\t\tctx.stroke();");
        pw.println("\t};");
        pw.println();
